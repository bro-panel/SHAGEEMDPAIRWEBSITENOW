            ...
            sock.ev.on("connection.update", async (s) => {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let md = "S=" + base64Session;
                        let code = await sock.sendMessage(sock.user.id, { text: md });
                        
                        let cap = `
🔐 *𝙳𝙾 𝙽𝙾𝚃 �𝚂𝙷𝙰𝚁𝙴 𝚃𝙷𝙸𝚂 𝙲𝙾𝙳𝙴 𝚆𝙸𝚃𝙷 �𝙽𝚈𝙾𝙽𝙴!!*

Use this code to create your own *𝐒ʜᴀɢᴇᴇ 𝐌ᴅ* WhatsApp User Bot. 🤖

🛠️ *To add your SESSION_ID:*  
1. Open the \`config.js\` file in the repo.  
...
`;
                    await sock.sendMessage(sock.user.id, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                title: "𝐒ʜᴀɢᴇᴇ 𝐌ᴅ",
                                thumbnailUrl: "https://i.ibb.co/sdsy6LG6/3mfp-OTP7c1.jpg",
